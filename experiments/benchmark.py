                ...
                for k in knn:
                    ...
                    if m == 'MASK':
                        file_name = "./experiments/NearestNeighbors/" + da + "/knn_" + da + "_" + str(
                            k) + "_" + di + "_" + m + "_tg" + str(tg) + "_nc" + str(nc) + "_r" + str(r) + "_" + str(algorithm) + "_" + str(implementation) + ".hdf5"
                    else:
                        file_name = "./experiments/NearestNeighbors/" + da + "/knn_" + da + "_" + str(
                            k) + "_" + di + "_" + m + ".hdf5"
        ...
        for di in distances:
            ...
            for m in methods:
                ...
                for k in knn:
                    ...
                    if m == 'MASK':
                        file_name = "./experiments/NearestNeighbors/" + da + "/knn_" + da + "_" + str(k) + "_" + di + "_" + m + "_tg" + str(tg) + "_nc" + str(nc) + "_r" + str(r) + "_" + str(algorithm) + "_" + str(implementation) + ".hdf5"
                    else:

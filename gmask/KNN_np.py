...
def gmask_tree(cant_ptos, tam_grupo, n_centroides, metrica, vector_original, dimensiones, algorithm, implementation):
...
def gmask_search(n_capas, n_centroides, seq_buscada, vector_original, vecinos, centroides_examinados,
...
def gmask_radius_search(n_centroides, punto_buscado, vector_original, k_vecinos, metrica,

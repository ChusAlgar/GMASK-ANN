...
logging.basicConfig(filename='../../../logs/modulado/chebyshev/result_km_overlap5.log', filemode='w', format='%(asctime)s - %(name)s - %(message)s',
                    level=logging.INFO)
...
logging.info('------------------------------------------------------------------------')
logging.info(' ')
logging.info('Sub Text MASK modulado, kmeans_tree_npdist_modulado')
...
n_capas, grupos_capa, puntos_capa, labels_capa = ktd.kmeans_tree(cant_ptos, tam_grupo,
                                                                 n_centroides, metrica, vector_original)
...
aciertos, fallos = ktd.kmeans_search(n_capas, n_centroides, vector_original, puntos_nube, metrica,
